...
public class DeclarationAbstractClass extends Declaration {

    private AbstractClassDecl AbstractClassDecl;

    public DeclarationAbstractClass (AbstractClassDecl AbstractClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationAbstractClass(\n");
