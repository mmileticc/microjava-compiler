...
">="        { return new_symbol(sym.GREATEQ, yytext()); }
"<"         { return new_symbol(sym.LESS, yytext()); }
"<="        { return new_symbol(sym.LESSEQ, yytext()); }
"&&"        { return new_symbol(sym.AND, yytext()); }
"||"        { return new_symbol(sym.OR, yytext()); }
"="         { return new_symbol(sym.ASIGN, yytext()); }
...
("true")                    { return new_symbol(sym.BOOLEAN, Boolean.TRUE); }
("false")                   { return new_symbol(sym.BOOLEAN, Boolean.FALSE); }
